...
import { Painting, newPainting, paintingMeta, Artist, ArtistId, ArtistOrder, artistMeta } from './entities';
...
import { Context } from 'src/context';
    ...
    export interface PaintingFields  {
      id: { kind: "primitive"; type: string; unique: true; nullable: false };title: { kind: "primitive"; type: string; unique: false; nullable: never };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };artist: { kind: "m2o"; type: Artist; nullable: never };
    }

    export interface PaintingOpts  {
      title: string;artist: Artist | ArtistId ;
    }
    ...
    export interface PaintingFilter  {
      id?: ValueFilter<PaintingId, never>;title?: ValueFilter<string, never>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;artist?: EntityFilter<Artist, ArtistId, FilterOf<Artist>, never>;
    }

    export interface PaintingGraphQLFilter  {
      id?: ValueGraphQLFilter<PaintingId>;title?: ValueGraphQLFilter<string>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;artist?: EntityGraphQLFilter<Artist, ArtistId, GraphQLFilterOf<Artist>, never>;
    }

    export interface PaintingOrder  {
      id?: OrderBy;title?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;artist?: ArtistOrder;
    }

    export const paintingConfig = new ConfigApi<Painting, Context>();

    paintingConfig.addRule(newRequiredRule("title"));paintingConfig.addRule(newRequiredRule("createdAt"));paintingConfig.addRule(newRequiredRule("updatedAt"));paintingConfig.addRule(newRequiredRule("artist"));
    ...
    export abstract class PaintingCodegen extends BaseEntity<EntityManager> {
      ...
      readonly artist: ManyToOneReference<Painting, Artist, never> =
        hasOne(
          artistMeta,
          "artist",
          "paintings",
      ...
      populate<const H extends LoadHint<Painting>, V>(opts: { hint: H, forceReload?: boolean }, fn: (p: Loaded<Painting, H>) => V): Promise<V>;
