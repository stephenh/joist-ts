...
import { Artist, newArtist, artistMeta, Painting, PaintingId, paintingMeta } from './entities';
...
import { Context } from 'src/context';
    ...
    export interface ArtistOpts  {
      firstName: string;lastName: string;paintings?: Painting[];
    }
    ...
    export interface ArtistFilter  {
      id?: ValueFilter<ArtistId, never>;firstName?: ValueFilter<string, never>;lastName?: ValueFilter<string, never>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;paintings?: EntityFilter<Painting, PaintingId, FilterOf<Painting>, null | undefined>;
    }

    export interface ArtistGraphQLFilter  {
      id?: ValueGraphQLFilter<ArtistId>;firstName?: ValueGraphQLFilter<string>;lastName?: ValueGraphQLFilter<string>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;paintings?: EntityGraphQLFilter<Painting, PaintingId, GraphQLFilterOf<Painting>, null | undefined>;
    }
    ...
    artistConfig.addRule(newRequiredRule("firstName"));artistConfig.addRule(newRequiredRule("lastName"));artistConfig.addRule(newRequiredRule("createdAt"));artistConfig.addRule(newRequiredRule("updatedAt"));
    ...
    export abstract class ArtistCodegen extends BaseEntity<EntityManager> {
      ...
      populate<const H extends LoadHint<Artist>, V>(opts: { hint: H, forceReload?: boolean }, fn: (artist: Loaded<Artist, H>) => V): Promise<V>;
