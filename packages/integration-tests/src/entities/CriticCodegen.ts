import { Flavor, ConfigApi, EntityMetadata, EntityOrmField, fail, setOpts, PartialOrNull, OptsOf, Changes, newChangesProxy, Lens, loadLens, LoadHint, Loaded, isLoaded, BaseEntity, ValueFilter, EntityFilter, FilterOf, ValueGraphQLFilter, EntityGraphQLFilter, GraphQLFilterOf, OrderBy, newRequiredRule, ManyToOneReference, hasOne, OneToOneReference, hasOneToOne, setField, cleanStringValue } from 'joist-orm';
import { Critic, newCritic, criticMeta, LargePublisher, PublisherGroup, LargePublisherId, PublisherGroupId, CriticColumn, CriticColumnId, LargePublisherOrder, PublisherGroupOrder, largePublisherMeta, publisherGroupMeta, criticColumnMeta } from './entities';
...
import { Context } from 'src/context';
    ...
    export interface CriticFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };name: { kind: "primitive"; type: string; unique: false; nullable: never };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };favoriteLargePublisher: { kind: "m2o"; type: LargePublisher; nullable: undefined };group: { kind: "m2o"; type: PublisherGroup; nullable: undefined };
    }

    export interface CriticOpts  {
      name: string;favoriteLargePublisher?: LargePublisher | LargePublisherId  | null;group?: PublisherGroup | PublisherGroupId  | null;criticColumn?: CriticColumn | null;
    }

    export interface CriticIdsOpts  {
      favoriteLargePublisherId?: LargePublisherId | null;groupId?: PublisherGroupId | null;criticColumnId?: CriticColumnId | null;
    }

    export interface CriticFilter  {
      id?: ValueFilter<CriticId, never>;name?: ValueFilter<string, never>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;favoriteLargePublisher?: EntityFilter<LargePublisher, LargePublisherId, FilterOf<LargePublisher>, null>;group?: EntityFilter<PublisherGroup, PublisherGroupId, FilterOf<PublisherGroup>, null>;criticColumn?: EntityFilter<CriticColumn, CriticColumnId, FilterOf<CriticColumn>, null | undefined>;
    }

    export interface CriticGraphQLFilter  {
      id?: ValueGraphQLFilter<CriticId>;name?: ValueGraphQLFilter<string>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;favoriteLargePublisher?: EntityGraphQLFilter<LargePublisher, LargePublisherId, GraphQLFilterOf<LargePublisher>, null>;group?: EntityGraphQLFilter<PublisherGroup, PublisherGroupId, GraphQLFilterOf<PublisherGroup>, null>;criticColumn?: EntityGraphQLFilter<CriticColumn, CriticColumnId, GraphQLFilterOf<CriticColumn>, null | undefined>;
    }

    export interface CriticOrder  {
      id?: OrderBy;name?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;favoriteLargePublisher?: LargePublisherOrder;group?: PublisherGroupOrder;
    }

    export const criticConfig = new ConfigApi<Critic, Context>();

    criticConfig.addRule(newRequiredRule("name"));criticConfig.addRule(newRequiredRule("createdAt"));criticConfig.addRule(newRequiredRule("updatedAt"));
    ...
    export abstract class CriticCodegen extends BaseEntity<EntityManager> {
      ...
      readonly favoriteLargePublisher: ManyToOneReference<Critic, LargePublisher, undefined> =
        hasOne(
          largePublisherMeta,
      ...
      readonly group: ManyToOneReference<Critic, PublisherGroup, undefined> =
        hasOne(
          publisherGroupMeta,
          "group",
          "critics",
      ...
      readonly criticColumn: OneToOneReference<Critic, CriticColumn> =
        hasOneToOne(
          criticColumnMeta,
          "criticColumn",
          "critic",
      ...
      populate<const H extends LoadHint<Critic>, V>(opts: { hint: H, forceReload?: boolean }, fn: (c: Loaded<Critic, H>) => V): Promise<V>;
