import { Flavor, ConfigApi, EntityMetadata, EntityOrmField, fail, setOpts, PartialOrNull, OptsOf, Changes, newChangesProxy, Lens, loadLens, LoadHint, Loaded, isLoaded, BaseEntity, MaybeAbstractEntityConstructor, Entity, IdOf, ValueFilter, EntityFilter, FilterOf, ValueGraphQLFilter, EntityGraphQLFilter, GraphQLFilterOf, OrderBy, newRequiredRule, ManyToOneReference, hasOne, Collection, hasManyToMany, PolymorphicReference, hasOnePolymorphic, setField, cleanStringValue } from 'joist-orm';
import { Comment, newComment, commentMeta, User, UserId, UserOrder, userMeta, Author, Book, BookReview, Publisher } from './entities';
...
import { Context } from 'src/context';
    ...
    export type CommentParent = | Author| Book| BookReview| Publisher;export function getCommentParentConstructors(): MaybeAbstractEntityConstructor<CommentParent>[] {
    ...
    export interface CommentFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };text: { kind: "primitive"; type: string; unique: false; nullable: undefined };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };user: { kind: "m2o"; type: User; nullable: undefined };parent: { kind: "poly"; type: CommentParent; nullable: never };
    }

    export interface CommentOpts  {
      text?: string | null;user?: User | UserId  | null;parent: CommentParent;likedByUsers?: User[];
    }

    export interface CommentIdsOpts  {
      userId?: UserId | null;parentId?:  IdOf<CommentParent> | null;likedByUserIds?: UserId[] | null;
    }

    export interface CommentFilter  {
      id?: ValueFilter<CommentId, never>;text?: ValueFilter<string, null>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;user?: EntityFilter<User, UserId, FilterOf<User>, null>;likedByUsers?: EntityFilter<User, UserId, FilterOf<User>, null | undefined>;parent?: EntityFilter<CommentParent, IdOf<CommentParent>, never, null | undefined>;
    }

    export interface CommentGraphQLFilter  {
      id?: ValueGraphQLFilter<CommentId>;text?: ValueGraphQLFilter<string>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;user?: EntityGraphQLFilter<User, UserId, GraphQLFilterOf<User>, null>;likedByUsers?: EntityGraphQLFilter<User, UserId, GraphQLFilterOf<User>, null | undefined>;parent?: EntityGraphQLFilter<CommentParent, IdOf<CommentParent>, never, null | undefined>;
    }

    export interface CommentOrder  {
      id?: OrderBy;text?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;user?: UserOrder;
    }

    export const commentConfig = new ConfigApi<Comment, Context>();

    commentConfig.addRule(newRequiredRule("createdAt"));commentConfig.addRule(newRequiredRule("updatedAt"));commentConfig.addRule(newRequiredRule("parent"));
    ...
    export abstract class CommentCodegen extends BaseEntity<EntityManager> {
      ...
      readonly user: ManyToOneReference<Comment, User, undefined> =
        hasOne(
          userMeta,
          "user",
          "createdComments",
      ...
      populate<const H extends LoadHint<Comment>, V>(opts: { hint: H, forceReload?: boolean }, fn: (comment: Loaded<Comment, H>) => V): Promise<V>;
