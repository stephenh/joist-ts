...
import { Context } from 'src/context';
    ...
    export interface CriticColumnFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };name: { kind: "primitive"; type: string; unique: false; nullable: never };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };critic: { kind: "m2o"; type: Critic; nullable: never };
    }

    export interface CriticColumnOpts  {
      name: string;critic: Critic | CriticId ;
    }
    ...
    export interface CriticColumnFilter  {
      id?: ValueFilter<CriticColumnId, never>;name?: ValueFilter<string, never>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;critic?: EntityFilter<Critic, CriticId, FilterOf<Critic>, never>;
    }

    export interface CriticColumnGraphQLFilter  {
      id?: ValueGraphQLFilter<CriticColumnId>;name?: ValueGraphQLFilter<string>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;critic?: EntityGraphQLFilter<Critic, CriticId, GraphQLFilterOf<Critic>, never>;
    }

    export interface CriticColumnOrder  {
      id?: OrderBy;name?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;critic?: CriticOrder;
    }

    export const criticColumnConfig = new ConfigApi<CriticColumn, Context>();

    criticColumnConfig.addRule(newRequiredRule("name"));criticColumnConfig.addRule(newRequiredRule("createdAt"));criticColumnConfig.addRule(newRequiredRule("updatedAt"));criticColumnConfig.addRule(newRequiredRule("critic"));
    ...
    export abstract class CriticColumnCodegen extends BaseEntity<EntityManager> {
      ...
      readonly critic: ManyToOneReference<CriticColumn, Critic, never> =
        hasOne(
          criticMeta,
          "critic",
          "criticColumn",
      ...
      populate<const H extends LoadHint<CriticColumn>>(opts: { hint: H, forceReload?: boolean }): Promise<Loaded<CriticColumn, H>>;
      populate<const H extends LoadHint<CriticColumn>, V>(hint: H, fn: (cc: Loaded<CriticColumn, H>) => V): Promise<V>;
      populate<const H extends LoadHint<CriticColumn>, V>(opts: { hint: H, forceReload?: boolean }, fn: (cc: Loaded<CriticColumn, H>) => V): Promise<V>;
