import { Flavor, ConfigApi, EntityMetadata, EntityOrmField, fail, setOpts, PartialOrNull, OptsOf, Changes, newChangesProxy, Lens, loadLens, LoadHint, Loaded, isLoaded, BaseEntity, ValueFilter, BooleanFilter, EntityFilter, FilterOf, ValueGraphQLFilter, BooleanGraphQLFilter, EntityGraphQLFilter, GraphQLFilterOf, OrderBy, newRequiredRule, ManyToOneReference, hasOne, OneToOneReference, hasOneToOne, setField, PersistedAsyncProperty } from 'joist-orm';
import { BookReview, newBookReview, bookReviewMeta, Book, BookId, Comment, CommentId, BookOrder, bookMeta, commentMeta } from './entities';
...
import { Context } from 'src/context';
    ...
    export interface BookReviewFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };rating: { kind: "primitive"; type: number; unique: false; nullable: never };isPublic: { kind: "primitive"; type: boolean; unique: false; nullable: never };isTest: { kind: "primitive"; type: boolean; unique: false; nullable: never };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };book: { kind: "m2o"; type: Book; nullable: never };
    }

    export interface BookReviewOpts  {
      rating: number;book: Book | BookId ;comment?: Comment | null;
    }

    export interface BookReviewIdsOpts  {
      bookId?: BookId | null;commentId?: CommentId | null;
    }

    export interface BookReviewFilter  {
      id?: ValueFilter<BookReviewId, never>;rating?: ValueFilter<number, never>;isPublic?: BooleanFilter<never>;isTest?: BooleanFilter<never>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;book?: EntityFilter<Book, BookId, FilterOf<Book>, never>;comment?: EntityFilter<Comment, CommentId, FilterOf<Comment>, null | undefined>;
    }

    export interface BookReviewGraphQLFilter  {
      id?: ValueGraphQLFilter<BookReviewId>;rating?: ValueGraphQLFilter<number>;isPublic?: BooleanGraphQLFilter;isTest?: BooleanGraphQLFilter;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;book?: EntityGraphQLFilter<Book, BookId, GraphQLFilterOf<Book>, never>;comment?: EntityGraphQLFilter<Comment, CommentId, GraphQLFilterOf<Comment>, null | undefined>;
    }

    export interface BookReviewOrder  {
      id?: OrderBy;rating?: OrderBy;isPublic?: OrderBy;isTest?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;book?: BookOrder;
    }

    export const bookReviewConfig = new ConfigApi<BookReview, Context>();

    bookReviewConfig.addRule(newRequiredRule("rating"));bookReviewConfig.addRule(newRequiredRule("isPublic"));bookReviewConfig.addRule(newRequiredRule("isTest"));bookReviewConfig.addRule(newRequiredRule("createdAt"));bookReviewConfig.addRule(newRequiredRule("updatedAt"));bookReviewConfig.addRule(newRequiredRule("book"));
    ...
    export abstract class BookReviewCodegen extends BaseEntity<EntityManager> {
      ...
      readonly book: ManyToOneReference<BookReview, Book, never> =
        hasOne(
          bookMeta,
          "book",
          "reviews",
      ...
      readonly comment: OneToOneReference<BookReview, Comment> =
        hasOneToOne(
          commentMeta,
          "comment",
          "parent",
      ...
      populate<const H extends LoadHint<BookReview>>(opts: { hint: H, forceReload?: boolean }): Promise<Loaded<BookReview, H>>;
      populate<const H extends LoadHint<BookReview>, V>(hint: H, fn: (br: Loaded<BookReview, H>) => V): Promise<V>;
      populate<const H extends LoadHint<BookReview>, V>(opts: { hint: H, forceReload?: boolean }, fn: (br: Loaded<BookReview, H>) => V): Promise<V>;
