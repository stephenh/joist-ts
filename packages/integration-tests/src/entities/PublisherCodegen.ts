import { Flavor, ConfigApi, EntityMetadata, EntityOrmField, fail, setOpts, PartialOrNull, OptsOf, Changes, newChangesProxy, Lens, loadLens, LoadHint, Loaded, isLoaded, BaseEntity, ValueFilter, EntityFilter, FilterOf, ValueGraphQLFilter, EntityGraphQLFilter, GraphQLFilterOf, OrderBy, newRequiredRule, setField, FieldsOf, Collection, hasMany, ManyToOneReference, hasOne, hasManyToMany, cleanStringValue } from 'joist-orm';
import { Publisher, newPublisher, publisherMeta, PublisherSize, PublisherType, PublisherGroup, PublisherGroupId, Author, BookAdvance, Comment, Image, Tag, AuthorId, BookAdvanceId, CommentId, ImageId, TagId, PublisherGroupOrder, PublisherSizeDetails, PublisherTypeDetails, LargePublisher, SmallPublisher, authorMeta, bookAdvanceMeta, commentMeta, imageMeta, publisherGroupMeta, tagMeta, PublisherTypes, PublisherSizes } from './entities';
...
import { Context } from 'src/context';
    ...
    export interface PublisherFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };name: { kind: "primitive"; type: string; unique: false; nullable: never };latitude: { kind: "primitive"; type: number; unique: false; nullable: undefined };longitude: { kind: "primitive"; type: number; unique: false; nullable: undefined };hugeNumber: { kind: "primitive"; type: number; unique: false; nullable: undefined };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };size: { kind: "enum"; type: PublisherSize; nullable: undefined };type: { kind: "enum"; type: PublisherType; nullable: never };group: { kind: "m2o"; type: PublisherGroup; nullable: undefined };
    }

    export interface PublisherOpts  {
      name: string;latitude?: number | null;longitude?: number | null;hugeNumber?: number | null;size?: PublisherSize | null;type?: PublisherType;group?: PublisherGroup | PublisherGroupId  | null;authors?: Author[];bookAdvances?: BookAdvance[];comments?: Comment[];images?: Image[];tags?: Tag[];
    }

    export interface PublisherIdsOpts  {
      groupId?: PublisherGroupId | null;authorIds?: AuthorId[] | null;bookAdvanceIds?: BookAdvanceId[] | null;commentIds?: CommentId[] | null;imageIds?: ImageId[] | null;tagIds?: TagId[] | null;
    }

    export interface PublisherFilter  {
      id?: ValueFilter<PublisherId, never>;name?: ValueFilter<string, never>;latitude?: ValueFilter<number, null>;longitude?: ValueFilter<number, null>;hugeNumber?: ValueFilter<number, null>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;size?: ValueFilter<PublisherSize, null>;type?: ValueFilter<PublisherType, never>;group?: EntityFilter<PublisherGroup, PublisherGroupId, FilterOf<PublisherGroup>, null>;authors?: EntityFilter<Author, AuthorId, FilterOf<Author>, null | undefined>;bookAdvances?: EntityFilter<BookAdvance, BookAdvanceId, FilterOf<BookAdvance>, null | undefined>;comments?: EntityFilter<Comment, CommentId, FilterOf<Comment>, null | undefined>;images?: EntityFilter<Image, ImageId, FilterOf<Image>, null | undefined>;tags?: EntityFilter<Tag, TagId, FilterOf<Tag>, null | undefined>;
    }

    export interface PublisherGraphQLFilter  {
      id?: ValueGraphQLFilter<PublisherId>;name?: ValueGraphQLFilter<string>;latitude?: ValueGraphQLFilter<number>;longitude?: ValueGraphQLFilter<number>;hugeNumber?: ValueGraphQLFilter<number>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;size?: ValueGraphQLFilter<PublisherSize>;type?: ValueGraphQLFilter<PublisherType>;group?: EntityGraphQLFilter<PublisherGroup, PublisherGroupId, GraphQLFilterOf<PublisherGroup>, null>;authors?: EntityGraphQLFilter<Author, AuthorId, GraphQLFilterOf<Author>, null | undefined>;bookAdvances?: EntityGraphQLFilter<BookAdvance, BookAdvanceId, GraphQLFilterOf<BookAdvance>, null | undefined>;comments?: EntityGraphQLFilter<Comment, CommentId, GraphQLFilterOf<Comment>, null | undefined>;images?: EntityGraphQLFilter<Image, ImageId, GraphQLFilterOf<Image>, null | undefined>;tags?: EntityGraphQLFilter<Tag, TagId, GraphQLFilterOf<Tag>, null | undefined>;
    }

    export interface PublisherOrder  {
      id?: OrderBy;name?: OrderBy;latitude?: OrderBy;longitude?: OrderBy;hugeNumber?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;size?: OrderBy;type?: OrderBy;group?: PublisherGroupOrder;
    }

    export const publisherConfig = new ConfigApi<Publisher, Context>();

    publisherConfig.addRule(newRequiredRule("name"));publisherConfig.addRule(newRequiredRule("createdAt"));publisherConfig.addRule(newRequiredRule("updatedAt"));publisherConfig.addRule(newRequiredRule("type"));
    ...
    export abstract class PublisherCodegen extends BaseEntity<EntityManager> {
      ...
      readonly group: ManyToOneReference<Publisher, PublisherGroup, undefined> =
        hasOne(
          publisherGroupMeta,
          "group",
          "publishers",
    ...
    if (this.constructor === Publisher && !(em as any).fakeInstance) {
      ...
      populate<const H extends LoadHint<Publisher>>(opts: { hint: H, forceReload?: boolean }): Promise<Loaded<Publisher, H>>;
      populate<const H extends LoadHint<Publisher>, V>(hint: H, fn: (p: Loaded<Publisher, H>) => V): Promise<V>;
      populate<const H extends LoadHint<Publisher>, V>(opts: { hint: H, forceReload?: boolean }, fn: (p: Loaded<Publisher, H>) => V): Promise<V>;
