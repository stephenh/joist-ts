import { Flavor, ConfigApi, EntityMetadata, EntityOrmField, fail, setOpts, PartialOrNull, OptsOf, Changes, newChangesProxy, Lens, loadLens, LoadHint, Loaded, isLoaded, BaseEntity, ValueFilter, EntityFilter, FilterOf, ValueGraphQLFilter, EntityGraphQLFilter, GraphQLFilterOf, OrderBy, newRequiredRule, Collection, hasMany, ManyToOneReference, hasOne, hasManyToMany, setField, cleanStringValue } from 'joist-orm';
import { User, newUser, userMeta, Author, AuthorId, Comment, CommentId, AuthorOrder, commentMeta, authorMeta } from './entities';
...
import { IpAddress, PasswordValue } from 'src/entities/types';
    ...
    export interface UserFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };name: { kind: "primitive"; type: string; unique: false; nullable: never };email: { kind: "primitive"; type: string; unique: false; nullable: never };ipAddress: { kind: "primitive"; type: IpAddress; unique: false; nullable: undefined };password: { kind: "primitive"; type: PasswordValue; unique: false; nullable: undefined };bio: { kind: "primitive"; type: string; unique: false; nullable: never };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };authorManyToOne: { kind: "m2o"; type: Author; nullable: undefined };
    }

    export interface UserOpts  {
      name: string;email: string;ipAddress?: IpAddress | null;password?: PasswordValue | null;bio?: string;authorManyToOne?: Author | AuthorId  | null;createdComments?: Comment[];likedComments?: Comment[];
    }

    export interface UserIdsOpts  {
      authorManyToOneId?: AuthorId | null;createdCommentIds?: CommentId[] | null;likedCommentIds?: CommentId[] | null;
    }

    export interface UserFilter  {
      id?: ValueFilter<UserId, never>;name?: ValueFilter<string, never>;email?: ValueFilter<string, never>;ipAddress?: ValueFilter<IpAddress, null>;password?: ValueFilter<PasswordValue, null>;bio?: ValueFilter<string, never>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;authorManyToOne?: EntityFilter<Author, AuthorId, FilterOf<Author>, null>;createdComments?: EntityFilter<Comment, CommentId, FilterOf<Comment>, null | undefined>;likedComments?: EntityFilter<Comment, CommentId, FilterOf<Comment>, null | undefined>;
    }

    export interface UserGraphQLFilter  {
      id?: ValueGraphQLFilter<UserId>;name?: ValueGraphQLFilter<string>;email?: ValueGraphQLFilter<string>;ipAddress?: ValueGraphQLFilter<IpAddress>;password?: ValueGraphQLFilter<PasswordValue>;bio?: ValueGraphQLFilter<string>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;authorManyToOne?: EntityGraphQLFilter<Author, AuthorId, GraphQLFilterOf<Author>, null>;createdComments?: EntityGraphQLFilter<Comment, CommentId, GraphQLFilterOf<Comment>, null | undefined>;likedComments?: EntityGraphQLFilter<Comment, CommentId, GraphQLFilterOf<Comment>, null | undefined>;
    }

    export interface UserOrder  {
      id?: OrderBy;name?: OrderBy;email?: OrderBy;ipAddress?: OrderBy;password?: OrderBy;bio?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;authorManyToOne?: AuthorOrder;
    }

    export const userConfig = new ConfigApi<User, Context>();

    userConfig.addRule(newRequiredRule("name"));userConfig.addRule(newRequiredRule("email"));userConfig.addRule(newRequiredRule("bio"));userConfig.addRule(newRequiredRule("createdAt"));userConfig.addRule(newRequiredRule("updatedAt"));
    ...
    export abstract class UserCodegen extends BaseEntity<EntityManager> {
      ...
      readonly authorManyToOne: ManyToOneReference<User, Author, undefined> =
        hasOne(
          authorMeta,
          "authorManyToOne",
          "userOneToOne",
      ...
      populate<const H extends LoadHint<User>, V>(opts: { hint: H, forceReload?: boolean }, fn: (u: Loaded<User, H>) => V): Promise<V>;
