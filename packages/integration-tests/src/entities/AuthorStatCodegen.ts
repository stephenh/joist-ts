...
import { AuthorStat, newAuthorStat, authorStatMeta } from './entities';
...
import { Context } from 'src/context';
    ...
    export interface AuthorStatFields  {
      id: { kind: "primitive"; type: number; unique: true; nullable: false };smallint: { kind: "primitive"; type: number; unique: false; nullable: never };integer: { kind: "primitive"; type: number; unique: false; nullable: never };nullableInteger: { kind: "primitive"; type: number; unique: false; nullable: undefined };bigint: { kind: "primitive"; type: bigint; unique: false; nullable: never };decimal: { kind: "primitive"; type: number; unique: false; nullable: never };real: { kind: "primitive"; type: number; unique: false; nullable: never };smallserial: { kind: "primitive"; type: number; unique: false; nullable: never };serial: { kind: "primitive"; type: number; unique: false; nullable: never };bigserial: { kind: "primitive"; type: bigint; unique: false; nullable: never };doublePrecision: { kind: "primitive"; type: number; unique: false; nullable: never };nullableText: { kind: "primitive"; type: string; unique: false; nullable: undefined };json: { kind: "primitive"; type: Object; unique: false; nullable: undefined };createdAt: { kind: "primitive"; type: Date; unique: false; nullable: never };updatedAt: { kind: "primitive"; type: Date; unique: false; nullable: never };
    }

    export interface AuthorStatOpts  {
      smallint: number;integer: number;nullableInteger?: number | null;bigint: bigint;decimal: number;real: number;smallserial: number;serial: number;bigserial: bigint;doublePrecision: number;nullableText?: string | null;json?: Object | null;
    }
    ...
    export interface AuthorStatFilter  {
      id?: ValueFilter<AuthorStatId, never>;smallint?: ValueFilter<number, never>;integer?: ValueFilter<number, never>;nullableInteger?: ValueFilter<number, null>;bigint?: ValueFilter<bigint, never>;decimal?: ValueFilter<number, never>;real?: ValueFilter<number, never>;smallserial?: ValueFilter<number, never>;serial?: ValueFilter<number, never>;bigserial?: ValueFilter<bigint, never>;doublePrecision?: ValueFilter<number, never>;nullableText?: ValueFilter<string, null>;json?: ValueFilter<Object, null>;createdAt?: ValueFilter<Date, never>;updatedAt?: ValueFilter<Date, never>;
    }

    export interface AuthorStatGraphQLFilter  {
      id?: ValueGraphQLFilter<AuthorStatId>;smallint?: ValueGraphQLFilter<number>;integer?: ValueGraphQLFilter<number>;nullableInteger?: ValueGraphQLFilter<number>;bigint?: ValueGraphQLFilter<bigint>;decimal?: ValueGraphQLFilter<number>;real?: ValueGraphQLFilter<number>;smallserial?: ValueGraphQLFilter<number>;serial?: ValueGraphQLFilter<number>;bigserial?: ValueGraphQLFilter<bigint>;doublePrecision?: ValueGraphQLFilter<number>;nullableText?: ValueGraphQLFilter<string>;json?: ValueGraphQLFilter<Object>;createdAt?: ValueGraphQLFilter<Date>;updatedAt?: ValueGraphQLFilter<Date>;
    }

    export interface AuthorStatOrder  {
      id?: OrderBy;smallint?: OrderBy;integer?: OrderBy;nullableInteger?: OrderBy;bigint?: OrderBy;decimal?: OrderBy;real?: OrderBy;smallserial?: OrderBy;serial?: OrderBy;bigserial?: OrderBy;doublePrecision?: OrderBy;nullableText?: OrderBy;json?: OrderBy;createdAt?: OrderBy;updatedAt?: OrderBy;
    }

    export const authorStatConfig = new ConfigApi<AuthorStat, Context>();

    authorStatConfig.addRule(newRequiredRule("smallint"));authorStatConfig.addRule(newRequiredRule("integer"));authorStatConfig.addRule(newRequiredRule("bigint"));authorStatConfig.addRule(newRequiredRule("decimal"));authorStatConfig.addRule(newRequiredRule("real"));authorStatConfig.addRule(newRequiredRule("smallserial"));authorStatConfig.addRule(newRequiredRule("serial"));authorStatConfig.addRule(newRequiredRule("bigserial"));authorStatConfig.addRule(newRequiredRule("doublePrecision"));authorStatConfig.addRule(newRequiredRule("createdAt"));authorStatConfig.addRule(newRequiredRule("updatedAt"));
    ...
    export abstract class AuthorStatCodegen extends BaseEntity<EntityManager> {
      ...
      populate<const H extends LoadHint<AuthorStat>>(opts: { hint: H, forceReload?: boolean }): Promise<Loaded<AuthorStat, H>>;
      populate<const H extends LoadHint<AuthorStat>, V>(hint: H, fn: (as: Loaded<AuthorStat, H>) => V): Promise<V>;
      populate<const H extends LoadHint<AuthorStat>, V>(opts: { hint: H, forceReload?: boolean }, fn: (as: Loaded<AuthorStat, H>) => V): Promise<V>;
